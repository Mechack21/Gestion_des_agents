 ...
 * @author MECHACK
 */
public class JfrmDivision extends javax.swing.JFrame {

    /**
     * Creates new form JfrmDivision
     */
    Division div = new Division();
    Direction drct = new Direction();
...
//        setTitle("");
        div.remplir(jTableDivision, "select DIVISION.Id_DIVISION,DIVISION.Libelle,DIRECTION.Libelle from DIVISION,DIRECTION where DIVISION.Id_DIRECTION=DIRECTION.Id_DIRECTION");
        drct.Charger(comboDirection);
    }

    void Nettoyer() {
        texteFldCodeDivision.setText("");
        textFldNomDivision.setText("");
        comboDirection.setSelectedItem("");
    }
    ...
    private void initComponents() {
        ...
        texteFldCodeDivision = new javax.swing.JTextField();
        textFldNomDivision = new javax.swing.JTextField();
        jLabel4 = new javax.swing.JLabel();
        comboDirection = new javax.swing.JComboBox();
        ...
        jLabel2.setText("CODE DU DIVISION");

        jLabel3.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(204, 0, 204));
        jLabel3.setText("NOM DU DIVISION");

        texteFldCodeDivision.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N

        textFldNomDivision.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N

        jLabel4.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(204, 0, 204));
        jLabel4.setText("DIRECTION");

        comboDirection.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(texteFldCodeDivision, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addComponent(textFldNomDivision, javax.swing.GroupLayout.PREFERRED_SIZE, 340, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addComponent(comboDirection, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addContainerGap())))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(texteFldCodeDivision, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(textFldNomDivision, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(comboDirection, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(26, Short.MAX_VALUE))
        );

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Coordonnées", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Baskerville Old Face", 0, 14), new java.awt.Color(204, 0, 204))); // NOI18N

        BTNETTOYER.setFont(new java.awt.Font("Baskerville Old Face", 3, 18)); // NOI18N
        BTNETTOYER.setForeground(new java.awt.Color(204, 0, 204));
        ...
        BTSUPPRIMER.setForeground(new java.awt.Color(204, 0, 204));
        ...
        BTAJOUTER.setForeground(new java.awt.Color(204, 0, 204));
        ...
        BTMODIFIER.setForeground(new java.awt.Color(204, 0, 204));
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(BTSUPPRIMER, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void BTAJOUTERActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTAJOUTERActionPerformed
        ...
        if (texteFldCodeDivision.getText().equals("") || textFldNomDivision.getText().equals("") || comboDirection.getSelectedItem().equals("")) {
            JOptionPane.showMessageDialog(null, "Veuillez remplir tous les champs", "ATTENTION!!", JOptionPane.ERROR_MESSAGE);
        } else {
            div.setId_DIVISION(texteFldCodeDivision.getText());
            div.setLibelle(textFldNomDivision.getText());
            String idfdrc = drct.IDDrc(comboDirection.getSelectedItem().toString());
            div.setId_DIRECTION(idfdrc);
//            div.setId_DIRECTION(comboDirection.getSelectedItem().toString());
            div.Ajouter();
            div.remplir(jTableDivision, "select DIVISION.Id_DIVISION,DIVISION.Libelle,DIRECTION.Libelle from DIVISION,DIRECTION where DIVISION.Id_DIRECTION=DIRECTION.Id_DIRECTION");
            Nettoyer();
        }
...
//            div.setId_DIRECTION(comboDirection.getSelectedItem().toString());
    ...
    private void jTableDivisionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableDivisionMouseClicked
        // TODO add your handling code here:
        int ligne = jTableDivision.getSelectedRow();
        texteFldCodeDivision.setText(jTableDivision.getValueAt(ligne, 0).toString());
        textFldNomDivision.setText(jTableDivision.getValueAt(ligne, 1).toString());
        comboDirection.setSelectedItem(jTableDivision.getValueAt(ligne, 2).toString());
    }//GEN-LAST:event_jTableDivisionMouseClicked

    private void texteFldRechercheKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_texteFldRechercheKeyTyped
        // TODO add your handling code here:
        div.remplir(jTableDivision, "select DIVISION.Id_DIVISION,DIVISION.Libelle,DIRECTION.Libelle from DIVISION,DIRECTION where DIVISION.Id_DIRECTION=DIRECTION.Id_DIRECTION and DIVISION.Id_DIRECTION like '%" + texteFldRecherche.getText() + "%'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JfrmDivision.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JComboBox comboDirection;
    ...
    private javax.swing.JTextField textFldNomDivision;
    private javax.swing.JTextField texteFldCodeDivision;
