 ...
 * @author MECHACK
 */
public class JfrmDistrict extends javax.swing.JFrame {

    /**
     * Creates new form JfrmDistrict
     */
    District dstrct = new District();
    Province prvnce = new Province();
...
//        setTitle("");
        dstrct.remplir(jTableDistrict, "select DISTRICT.Id_DISTRICT,DISTRICT.Libelle,PROVINCE.Libelle from DISTRICT,PROVINCE where DISTRICT.Id_PROVINCE=PROVINCE.Id_PROVINCE");
        prvnce.Charger(comboProvince);

    }

    void Nettoyer() {
        texteFldCodeDistrict.setText("");
        textFldNomDistrict.setText("");
        comboProvince.setSelectedItem("");
    }
    ...
    private void initComponents() {
        ...
        texteFldCodeDistrict = new javax.swing.JTextField();
        textFldNomDistrict = new javax.swing.JTextField();
        ...
        jLabel2.setText("CODE DU DISTRICT");

        jLabel3.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(51, 153, 255));
        jLabel3.setText("NOM DU DISTRICT");

        texteFldCodeDistrict.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N

        textFldNomDistrict.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N

        jLabel4.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(51, 153, 255));
        jLabel4.setText("PROVINCE");

        comboProvince.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(24, 24, 24)
                        .addComponent(textFldNomDistrict, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(texteFldCodeDistrict, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(jLabel4)
                                .addGap(22, 22, 22)
                                .addComponent(comboProvince, javax.swing.GroupLayout.PREFERRED_SIZE, 262, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(texteFldCodeDistrict, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(textFldNomDistrict, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
        ...
        BTNETTOYER.setForeground(new java.awt.Color(51, 153, 255));
        ...
        BTSUPPRIMER.setForeground(new java.awt.Color(51, 153, 255));
        ...
        BTAJOUTER.setForeground(new java.awt.Color(51, 153, 255));
        ...
        BTMODIFIER.setForeground(new java.awt.Color(51, 153, 255));
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Coordonnées", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Baskerville Old Face", 0, 14), new java.awt.Color(51, 153, 255))); // NOI18N
        ...
        jTableDistrict.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTableDistrictMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTableDistrict);
    ...
    private void BTAJOUTERActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTAJOUTERActionPerformed
        ...
        if (texteFldCodeDistrict.getText().equals("") || textFldNomDistrict.getText().equals("") || comboProvince.getSelectedItem().equals("")) {
            JOptionPane.showMessageDialog(null, "Veuillez remplir tous les champs", "ATTENTION!!", JOptionPane.ERROR_MESSAGE);
        } else {
            dstrct.setId_DISTRICT(texteFldCodeDistrict.getText());
            dstrct.setLibelle(textFldNomDistrict.getText());
            String idp = prvnce.IDP(comboProvince.getSelectedItem().toString());
            dstrct.setId_PROVINCE(idp);
//            dstrct.setId_PROVINCE(comboProvince.getSelectedItem().toString());
            dstrct.Ajouter();
            dstrct.remplir(jTableDistrict, "select DISTRICT.Id_DISTRICT,DISTRICT.Libelle,PROVINCE.Libelle from DISTRICT,PROVINCE where DISTRICT.Id_PROVINCE=PROVINCE.Id_PROVINCE");
            Nettoyer();
        }
...
//            dstrct.setId_PROVINCE(comboProvince.getSelectedItem().toString());
    ...
    private void jTableDistrictMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableDistrictMouseClicked
        // TODO add your handling code here:
        int ligne = jTableDistrict.getSelectedRow();
        texteFldCodeDistrict.setText(jTableDistrict.getValueAt(ligne, 0).toString());
        textFldNomDistrict.setText(jTableDistrict.getValueAt(ligne, 1).toString());
        comboProvince.setSelectedItem(jTableDistrict.getValueAt(ligne, 2).toString());
    }//GEN-LAST:event_jTableDistrictMouseClicked

    private void texteFldRechercheKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_texteFldRechercheKeyTyped
        // TODO add your handling code here:
        dstrct.remplir(jTableDistrict, "select DISTRICT.Id_DISTRICT,DISTRICT.Libelle,PROVINCE.Libelle from DISTRICT,PROVINCE where DISTRICT.Id_PROVINCE=PROVINCE.Id_PROVINCE and DISTRICT.Libelle like '%" + texteFldRecherche.getText() + "%'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JfrmDistrict.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField textFldNomDistrict;
    private javax.swing.JTextField texteFldCodeDistrict;
