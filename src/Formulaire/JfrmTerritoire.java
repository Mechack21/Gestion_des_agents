 ...
 * @author MECHACK
 */
public class JfrmTerritoire extends javax.swing.JFrame {

    Territoire tr = new Territoire();
    District dis = new District();

    /**
     * Creates new form JfrmTerritoire
     */
    public JfrmTerritoire() {
        initComponents();
        setResizable(false);
        setLocationRelativeTo(null);
//        setTitle("");
        tr.remplir(jTableTerritoire, "select TERRITOIRE.Id_TERRITOIRE,TERRITOIRE.Libelle, DISTRICT.Libelle from TERRITOIRE,DISTRICT where TERRITOIRE.Id_DISTRICT=DISTRICT.Id_DISTRICT");
        dis.Charger(comboDistrict);
    }

    void Nettoyer() {
        texteFldCodeTerritoire.setText("");
        textFldNomTerritoire.setText("");
        comboDistrict.setSelectedItem("");
    }
    ...
    private void initComponents() {
        ...
        texteFldCodeTerritoire = new javax.swing.JTextField();
        textFldNomTerritoire = new javax.swing.JTextField();
        ...
        jTableTerritoire = new javax.swing.JTable();
        ...
        jLabel2.setText("CODE DU TERRITOIRE");

        jLabel3.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(204, 0, 204));
        jLabel3.setText("NOM DU TERRITOIRE");

        texteFldCodeTerritoire.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N

        textFldNomTerritoire.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N

        jLabel4.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(204, 0, 204));
        jLabel4.setText("DISTRICT");

        comboDistrict.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(24, 24, 24)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(textFldNomTerritoire)
                            .addComponent(comboDistrict, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel2)
                        .addGap(18, 18, 18)
                        .addComponent(texteFldCodeTerritoire, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(texteFldCodeTerritoire, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(textFldNomTerritoire, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(BTNETTOYER, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jTableTerritoire.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jTableTerritoire.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTableTerritoireMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTableTerritoire);
        ...
        jMenuItem11.setText("Secretariat");
    ...
    private void BTAJOUTERActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTAJOUTERActionPerformed
        ...
        if (texteFldCodeTerritoire.getText().equals("") || textFldNomTerritoire.getText().equals("") || comboDistrict.getSelectedItem().equals("")) {
            JOptionPane.showMessageDialog(null, "Veuillez remplir tous les champs", "ATTENTION!!", JOptionPane.ERROR_MESSAGE);
        } else {
            tr.setId_TERRITOIRE(texteFldCodeTerritoire.getText());
            tr.setLibelle(textFldNomTerritoire.getText());
//            tr.setID_DISTRICT(comboDistrict.getSelectedItem().toString());
            String idd = dis.IDdis(comboDistrict.getSelectedItem().toString());
            tr.setID_DISTRICT(idd);
            tr.Ajouter();
            tr.remplir(jTableTerritoire, "select TERRITOIRE.Id_TERRITOIRE,TERRITOIRE.Libelle, DISTRICT.Libelle from TERRITOIRE,DISTRICT where TERRITOIRE.Id_DISTRICT=DISTRICT.Id_DISTRICT");
            Nettoyer();
        }
...
//            scrt.setId_MINISTERE(idM);
    ...
    private void jTableTerritoireMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableTerritoireMouseClicked
        // TODO add your handling code here:
        int ligne = jTableTerritoire.getSelectedRow();
        texteFldCodeTerritoire.setText(jTableTerritoire.getValueAt(ligne, 0).toString());
        textFldNomTerritoire.setText(jTableTerritoire.getValueAt(ligne, 1).toString());
        comboDistrict.setSelectedItem(jTableTerritoire.getValueAt(ligne, 2).toString());
    }//GEN-LAST:event_jTableTerritoireMouseClicked

    private void texteFldRechercheKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_texteFldRechercheKeyTyped
        // TODO add your handling code here:
        tr.remplir(jTableTerritoire, "select TERRITOIRE.Id_TERRITOIRE,TERRITOIRE.Libelle, DISTRICT.Libelle from TERRITOIRE,DISTRICT where TERRITOIRE.Id_DISTRICT=DISTRICT.Id_DISTRICT and TERRITOIRE.Libelle like '%" + texteFldRecherche.getText() + "%'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JfrmTerritoire.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable jTableTerritoire;
    private javax.swing.JTextField textFldNomTerritoire;
    private javax.swing.JTextField texteFldCodeTerritoire;
