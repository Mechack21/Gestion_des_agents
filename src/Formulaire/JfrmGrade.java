 ...
 * @author MECHACK
 */
public class JfrmGrade extends javax.swing.JFrame {

    /**
     * Creates new form JfrmGrade
     */
    Grade gr = new Grade();
...
//        setTitle("");
        gr.remplir(jTableGrade, "select * from grade");
    }

    void Nettoyer() {
        texteFldCodeGrade.setText("");
        textFldNomGrade.setText("");
    }
    ...
    private void initComponents() {
        ...
        texteFldCodeGrade = new javax.swing.JTextField();
        textFldNomGrade = new javax.swing.JTextField();
        ...
        jLabel2.setText("CODE DU GRADE");

        jLabel3.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(102, 153, 255));
        jLabel3.setText("DENOMINATION");

        texteFldCodeGrade.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N

        textFldNomGrade.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(textFldNomGrade)
                        .addContainerGap())
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel2)
                        .addGap(18, 18, 18)
                        .addComponent(texteFldCodeGrade, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(texteFldCodeGrade, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(textFldNomGrade, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        BTNETTOYER.setForeground(new java.awt.Color(102, 153, 255));
        ...
        BTSUPPRIMER.setForeground(new java.awt.Color(102, 153, 255));
        ...
        BTAJOUTER.setForeground(new java.awt.Color(102, 153, 255));
        ...
        BTMODIFIER.setForeground(new java.awt.Color(102, 153, 255));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(BTAJOUTER, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void BTAJOUTERActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTAJOUTERActionPerformed
        ...
        if (texteFldCodeGrade.getText().equals("") || textFldNomGrade.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Veuillez remplir tous les champs", "ATTENTION!!", JOptionPane.ERROR_MESSAGE);
        } else {
            gr.setId_Grade(texteFldCodeGrade.getText());
            gr.setLibelle(textFldNomGrade.getText());
            gr.Ajouter();
            gr.remplir(jTableGrade, "select * from grade");
            Nettoyer();
        }
    ...
    private void jTableGradeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableGradeMouseClicked
        // TODO add your handling code here:
        int ligne = jTableGrade.getSelectedRow();
        texteFldCodeGrade.setText(jTableGrade.getValueAt(ligne, 0).toString());
        textFldNomGrade.setText(jTableGrade.getValueAt(ligne, 1).toString());
    ...
    private void texteFldRechercheKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_texteFldRechercheKeyTyped
        // TODO add your handling code here:
        gr.remplir(jTableGrade, "select * from GRADE where Libelle like '%" + texteFldRecherche.getText() + "%'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JfrmGrade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField textFldNomGrade;
    private javax.swing.JTextField texteFldCodeGrade;
